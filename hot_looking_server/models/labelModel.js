...
module.exports.getVideoByLikes = async (lId) => {
    const sql = "select l.lName , v.category , v.vId , v.contentImg from label l , videos v where l.lId = v.lId and l.lId = ? order by v.likes desc limit 0,3;\n";
...
module.exports.getHotByLabel = async (lId) => {
    const sql = "(select\n" +
        "       n.nId , n.category , l.lId ,l.lName,n.img,n.title,n.summary,n.releaseTime,n.likes,COUNT(nc.content) 'cCount',u.uId,u.name,u.avatar\n" +
        "from\n" +
