...
module.exports.getAVTotal = async () => {
    const sql = "select SUM(v.count + a.count) total from (select COUNT(*) count from hot_con where category = 'videos') v , (select COUNT(*) count from hot_con where category = 'articles') a;";
